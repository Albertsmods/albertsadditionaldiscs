...
import static com.albertsmods.albertsadditionaldiscs.init.BlockInit.BLOCKS;
import static com.albertsmods.albertsadditionaldiscs.init.ModPoiTypes.POI_TYPES;
import static com.albertsmods.albertsadditionaldiscs.init.ModProfessions.PROFFESIONS;
...
public class AlbertsAdditionalDiscs {
    ...
    // Hop
    public static final RegistryObject<Item> HOP_MUSIC_DISC = ITEMS.register("hop_disc",
            () -> new AlbertsAdditionalDiscsMusicDisc(1, AlbertsAdditionalDiscs.HOP_DISC_LAZY.get(),
                    new Item.Properties().rarity(Rarity.RARE).stacksTo(1).tab(ModCreativeModeTab.ALBERTSADDITIONALDISCS_TAB)));
    ...
    // Hop
    public static final Lazy<SoundEvent> HOP_DISC_LAZY = Lazy.of(() -> new SoundEvent(new
            ResourceLocation(AlbertsAdditionalDiscs.MOD_ID, "item.hop_disc")));

    public static final RegistryObject<SoundEvent> HOP_DISC = SOUNDS.register("item.hop_disc.disc", HOP_DISC_LAZY);
    ...
    public AlbertsAdditionalDiscs() {
        ...
        PROFFESIONS.register(FMLJavaModLoadingContext.get().getModEventBus());
